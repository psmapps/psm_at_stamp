      ...
      if (version.contains('13') == true) {
        ...
        switch (result.status) {
              ...
              Firestore.instance
                ...
                if (valfire.exists) {
                  ...
                  if (remoteaccessToken != accessToken &&
                      remoteaccessToken != "") {
                    showMessageBox(false, "การเข้าสู่ระบบซ้ำ",
          ...
          case AuthorizationStatus.cancelled:
            Navigator.pop(context);
            showMessageBox(false, "คุณยกเลิกการเข้าสู่ระบบ",
          ...
          case AuthorizationStatus.error:
            print(result.error);
            Navigator.pop(context);
            showMessageBox(false, "เกิดข้อผิดพลาด",
    ...
    try {
      ...
      switch (e.code.toString()) {
        ...
        case "CANCEL":
          ...
          break;
        case "-1200":
          showMessageBox(false, "กรุณาตรวจสอบการเชื่อมต่ออินเตอร์เน็ต",
              "ไม่สามารถติดต่อกับ LINE ได้ กรุณาตรวจสอบการเชื่อมต่ออินเตอร์เน็ตและลองใหม่อีกครั้ง");
          print("Connection Failed");
          break;
        case "AUTHENTICATION_AGENT_ERROR":
          showMessageBox(false, "คุณไม่อนุญาติการเข้าสู่ระบบด้วย LINE",
              "เมื่อสักครู่คุณกดยกเลิกการเข้าสู่ระบบ กรุณาเข้าสู่ระบบใหม่อีกครั้ง");
          print("User decline the login");
          break;
        case "NETWORK_ERROR":
          showMessageBox(false, "ไม่สามารถเชื่อมต่อกับ LINE ได้",
