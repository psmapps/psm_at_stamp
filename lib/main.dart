...
void sendNotification(title, message) async {
  ...
  await flutterLocalNotificationsPlugin
      .show(111, title, message, platformChannelSpecifics, payload: message);
}
        ...
        if (loginStatus == false || loginStatus == null) {
          ...
          Firestore.instance
            ...
            if (!doc.exists) {
              ...
              showMessageBox("ไม่พบบัญชีของคุณ",
                  "บัญชีของคุณอาจถุกระงับ หรือ ถูกลบ กรุณาติดต่อ PSM @ STAMP Support Team หากมีปัญหาในการใช้งาน ขณะนี้คุณได้ออกจากระบบแล้ว");
            } else {
              ...
              if (remoteaccessToken != accessToken) {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => LoginPage()));
                showMessageBox("Session นี้หมดอายุแล้ว",
                    "อาจเป็นเพราะ บัญชีนี้มีการเข้าสู่ระบบจากอุปกรณ์อื่น คุณจะถูกบังคับออกจากระบบในอุปกรณ์เครื่องนี้โดยอัตโนมัติ");
              } else {
                print("Success");
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Wrap(
                        children: <Widget>[
                          Text("กำลังเชื่อมต่อกับระบบ PSM @ STAMP",
                              style:
